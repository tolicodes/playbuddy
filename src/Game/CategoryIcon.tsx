...
import { faPaintBrush, faCompass, faHeart, faHandshake, faUserFriends, faGlobeAmericas, faFeather, faComments, faMask, faExclamationTriangle, faSpa, faBolt, faHandcuffs, faDragon, faShieldAlt, faLink, faLaughBeam, faEye, faFire, faStreetView, faHourglassHalf, faQuestionCircle, IconDefinition, faBandAid, faCampground, faChalkboardTeacher, faEyeSlash, faGamepad, faGifts, faHandHoldingHeart, faHeartbeat, faLockOpen, faPalette, faRunning, faSitemap, faStar, faTree, faUserNinja, faUserSecret, faUsers, faBlind, faHandSparkles, faHandsHelping, faLightbulb, faPuzzlePiece, faSeedling, faSwimmer, faTheaterMasks, faTrophy, faCompressArrowsAlt, faFeatherAlt, faGift, faHourglassEnd, faMicrophone, faPeopleArrows, faSkullCrossbones, faSmileBeam, faTransgender, faUnlockAlt, faAnchor, faArrowRight, faBalanceScale, faBan, faBath, faBed, faBeer, faBookOpen, faBrain, faBriefcase, faBriefcaseMedical, faCamera, faCameraRetro, faChessQueen, faClipboardList, faCloud, faCloudMoon, faCloudSun, faCommentDots, faCouch, faCut, faDeaf, faDice, faDigitalTachograph, faDizzy, faDog, faDoorClosed, faDove, faExchangeAlt, faExclamationCircle, faExpandArrowsAlt, faEyeDropper, faGem, faGhost, faGlobe, faGrinWink, faHandPeace, faHandRock, faHands, faHatWizard, faHome, faImages, faInfinity, faJournalWhills, faLaptopCode, faLaugh, faLeaf, faMagic, faMapSigns, faMemory, faMicrochip, faMountain, faMusic, faObjectGroup, faOm, faParachuteBox, faPaw, faPlane, faPlaneDeparture, faPlay, faPlug, faPray, faQuestion, faRedo, faRing, faRobot, faRuler, faRulerCombined, faSadCry, faSatelliteDish, faScroll, faSearch, faSearchPlus, faShareAlt, faSignal, faSmile, faSoap, faThermometerFull, faThermometerHalf, faThumbsDown, faThumbsUp, faTint, faToolbox, faTshirt, faUserCircle, faUserLock, faUserTie, faUsersSlash, faUtensils, faVenusMars, faVial, faVideo, faVolumeUp, faWalking, faWater, faWaveSquare, faWifi } from '@fortawesome/free-solid-svg-icons';
...
const CategoryIcon = ({ category, size = 'big' }: { 
  ...
  const categoryIcon = categoryIcons[category] || defaultIcon as IconDefinition;
