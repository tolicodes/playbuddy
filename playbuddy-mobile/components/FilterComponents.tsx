...
export const DropdownMultiselect = ({
    ...
    <View style={styles.dropdownContainer}>
        ...
        <View style={styles.dropdownPillContainer}>
            {options.map(option => (
                <TouchableOpacity
                    key={option}
                    style={[styles.dropdownPill, selected.includes(option) && styles.dropdownPillSelected]}
                    onPress={() => onToggle(option)}
                >
                    <Text style={[styles.dropdownPillText, selected.includes(option) && styles.dropdownPillTextSelected]}>
                        {option}
                    </Text>
                </TouchableOpacity>
            ))}
...
export default { TagPill, Pill, DropdownMultiselect };
