...
// import { EventDataSource } from "../../commonTypes.js";
...
// export const scrapeWhatsappLinks = (whatsappGroups: { group_name: string, community_id: string }[], eventDataSource: EventDataSource): Promise<EventDataSource[]> => {
//   return new Promise<EventDataSource[]>((resolve, reject) => {
...
//         const linkMatches: EventDataSource[] = [];
...
//           const communities = [...eventDataSource.communities || [], {
