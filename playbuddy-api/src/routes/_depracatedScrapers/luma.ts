...
// function transformToStandardFormat(apiResponse: any, eventDataSource: EventDataSource): NormalizedEventInput {
//     const event = apiResponse.data.event;
//     const calendar = apiResponse.data.calendar;

//     // Extracting event details
//     const transformedEvent: NormalizedEventInput = {
...
//         return [transformToStandardFormat(response.data, eventDataSource)];
//     } catch (error) {
